    ...
    <body>
        ...
        <section class="col-lg-7 usuario" style="height:400px;overflow-y:scroll;">
            <?php //var_dump($allusers);
                $fila = "";
                foreach ($allusers as $clave => $valor)
                {
                $fila .= '	<tr producto_id="'.$valor["id"].'">';
                $fila .= "		<td>".$valor["nombre"]."</td>";
                $fila .= "		<td>".$valor["apellido"]."</td>";
                $fila .= "		<td>".$valor["email"]."</td>";
                $fila .= "	</tr>";
                }
                echo $fila;
            ?>
        ...
        <footer class="col-lg-12">
            <hr/>
           Ejemplo PHP PDO POO MVC - TANNY NOGALES - Copyright &copy; <?php echo  date("Y"); ?>
        </footer>
    </body>
</html>