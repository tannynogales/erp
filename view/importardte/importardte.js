...
$(document).ready(function()
{
    ...
    $("#table_product_result tbody").on("click", "tr", function()
    {
        ...
        var costo   = $(this).find(":eq(2)").text();
        var precio  = $(this).find(":eq(3)").text();
        //alert( $(cod).html() );
            ...
            callback: function (result) {
                ...
                if(result)
                {
                    ...
                    if( existe === 0 )
                    {
                        ...
                        tr += ' <td><input campo="costo"    name="producto_costo_'+prod_id+'"    type="text"  class="form-control" value="'+costo+'"></td>';
